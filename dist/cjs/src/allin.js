...
class allin extends allin$1 {
        ...
        return this.deepExtend(super.describe(), {
            ...
            'exceptions': {
                ...
                'exact': {
                    ...
                    '10500': errors.InsufficientFunds,
    ...
    parsePosition(position, market) {
        ...
        const notional = this.parseNumber(Precise["default"].stringMul(amount, lastPrice)) * size;
    ...
    handleErrors(statusCode, statusText, url, method, responseHeaders, responseBody, response, requestHeaders, requestBody) {
        if (statusCode >= 400) {
            throw new errors.NetworkError(this.id + ' http-code=' + this.numberToString(statusCode) + ', ' + statusText);
        }
        // const response = { 'code': 0,
        //     'msg': 'ok',
        //     'data': [
