...
class allin(Exchange, ImplicitAPI):
    ...
    async def fetch_order_book(self, symbol: str, limit: Int = 50, params={}) -> OrderBook:
        """
    ...
    async def fetch_orders(self, symbol: Str, since: Int = None, limit: Int = None, params={}) -> List[Order]:
        """
